...
function Content() {
    ...
    return (
        <>
            <Banner link="/" name={detailProduct.product_id} />
                        ...
                        <div className="col-md-7 single-top-left ">
                            <div className="single-right">
                                ...
                                <div className="pr-single">
                                    {(detailProduct.sale === 0) ? (<p className="reduced ">$ {detailProduct.price}</p>) : (<p className="reduced "><del>$ {detailProduct.price}</del>$ {detailProduct.price - ((detailProduct.price * detailProduct.sale) / 100)}</p>)}
                                ...
                                <div className="add add-3">
                                    <button onClick={() => addCart(detailProduct)} className="btn btn-danger my-cart-btn my-cart-b" data-id={1} data-name="Wheat" data-summary="summary 1" data-price={6.00} data-quantity={1} data-image="images/si.jpg">Add to Cart</button>
                                </div>
